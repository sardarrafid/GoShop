...
@include('theam.layout.layout')  
                    ...
                    <div class="col-lg-9 col-xl-9 col-md-8 col-xs-12">
                        ...
                        <div class="slider__container slider--one">
                            <div class="slider__activation__wrap owl-carousel owl-theme">
                                <!-- Start Single Slide -->
                                <div class="slide slider__full--screen slider-height-inherit slider-text-right" style="background: rgba(0, 0, 0, 0) url({{asset('theam/images/slider/bg/1.png')}}) no-repeat scroll center center / cover ;">
                                    <div class="container">
                                        <div class="row">
                    ...
                    <div class="col-lg-3 col-xl-3 col-md-4 col-xs-12">
                        <div class="categories-menu mrg-xs">
                            ...
                            <div class="category-menu-list">
                                <ul>
                                    <li><a href="#"><img alt="" src="{{asset('theam/images/icons/thum2.png')}}"> Women’s Clothing <i class="zmdi zmdi-chevron-right"></i></a>
                                        
                                    </li>
                                    <li><a href="#"><img alt="" src="{{ asset('theam/images/icons/thum3.png') }}"> Man Fashion <i class="zmdi zmdi-chevron-right"></i></a>
                                        
                                    </li>
                                    <li><a href="#"><img alt="" src="{{asset('theam/images/icons/thum4.png')}}"> Computer & Office <i class="zmdi zmdi-chevron-right"></i></a>
                                        
                                    </li>
                                    <li><a href="#"><img alt="" src="{{ asset('theam/images/icons/thum5.png') }}"> Jewelry & Watches <i class="zmdi zmdi-chevron-right"></i></a>
                                        
                                    </li>
                                    <li><a href="#"><img alt="" src="{{ asset('theam/images/icons/thum6.png') }}"> Men’s Clothing <i class="zmdi zmdi-chevron-right"></i></a>
                                        
                                    </li>
                                    <li><a href="#"><img alt="" src="{{ asset('theam/images/icons/thum7.png') }}"> Bags & Shoes</a></li>
                                    <li><a href="#"><img alt="" src="{{ asset('theam/images/icons/thum8.png') }}"> Toys & Kids & Baby</a></li>
                                    <li><a href="#"><img alt="" src="{{ asset('theam/images/icons/thum9.png') }}">  Automobiles </a></li>
                                    <li><a href="#"><img alt="" src="{{ asset('theam/images/icons/thum10.png') }}"> Jewelry & Watches</a></li>
                                    ...
                                    <div class="product-slider-active owl-carousel">
                                        <div class="product">
                                            <div class="product__inner">
                                                <div class="pro__thumb">
                                                    <a href="#">
                                                        <img src="{{ asset('theam/images/product/1.png') }}" alt="product images">
                                                    </a>
                                                </div>
                                        ...
                                        <div class="product">
                                            <div class="product__inner">
                                                <div class="pro__thumb">
                                                    <a href="#">
                                                        <img src="{{ asset('theam/images/product/4.png') }}" alt="product images">
                                                    </a>
                                                </div>
                                                <div class="product__hover__info">
                                                    <ul class="product__action">
        ...
        <div class="only-banner ptb--100 bg__white">
            <div class="container">
                <div class="only-banner-img">
                    <a href="shop-sidebar.html"><img src="{{ asset('theam/images/new-product/6.jpg') }}" alt="new product"></a>
                </div>
            </div>
        </div>
        <!-- Start Our Product Area -->
                        ...
                        <div class="col-lg-4 col-xl-4 col-md-6 col-12">
                            <div class="blog foo">
                                <div class="blog__inner">
                                    <div class="blog__thumb">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('theam/images/blog/blog-img/2.jpg') }}" alt="blog images">
                                        </a>
                                        <div class="blog__post__time">
                                            <div class="post__time--inner">
                                                <span class="date">14</span>
